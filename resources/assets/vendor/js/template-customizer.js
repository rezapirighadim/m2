...
TemplateCustomizer.LANGUAGES = {
  ...
  fa: {
    panel_header: "سفارشی‌ساز قالب",
    panel_sub_header: "شخصی‌سازی و پیش‌نمایش در زمان واقعی",
    theming_header: "قالب‌بندی",
    theme_header: "قالب",
    theme_label: "قالب‌ها",
    style_label: "سبک (حالت)",
    style_switch_light: "روشن",
    style_switch_dark: "تاریک",
    layout_header: "چیدمان",
    layout_label: "چیدمان (منو)",
    layout_static: "ایستا",
    layout_offcanvas: "خارج از بوم",
    layout_fixed: "ثابت",
    layout_fixed_offcanvas: "خارج از بوم ثابت",
    layout_flipped_label: "منوی معکوس",
    layout_dd_open_label: "منوی کشویی با شناور",
    layout_navbar_label: "ناوبار ثابت",
    layout_footer_label: "پاورقی ثابت",
    misc_header: "متفرقه",
    rtl_label: "جهت RTL"
  },
  fr: {
